...
#c("UPF_sg1_rs_q", "UPF_sg2_rs_q", "UPF_sg3_rs_q", "UPF_sg4_rs_q", "UPF_sg5_rs_q" )
#c("UPF_s1_rs_q", "UPF_s2_rs_q", "UPF_s3_rs_q", "UPF_s4_rs_q", "UPF_s5_rs_q")
...
#unweighted score is easy
df$UPF_sg_sum <- rowSums(data.frame(lapply(df[, upf_q_or_bin], as.numeric)))
...
plot_df <- weighted_score_for_plot(consumption_profiles, outcome_labels, weights_split_oc)
