...
#dataset already contains UPF variables, with subgroups, healthy diet score and obesity related cancer variables.
...
################################################################################
#generate table 1, need to run script 5.0 prior.
################################################################################
